        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs space-y-4">
          ...
          <div className="space-y-3">
            {recentProgrammes.length === 0 ? (
              <div className="p-6 text-center text-xs text-slate-500 bg-slate-50 rounded-lg space-y-2">
                <p>No academic programmes created yet.</p>
                <button
                  onClick={onOpenStudio}
                  className="px-3 py-1.5 bg-[#0a192f] text-white rounded text-xs font-semibold inline-flex items-center gap-1 hover:bg-slate-800"
                >
